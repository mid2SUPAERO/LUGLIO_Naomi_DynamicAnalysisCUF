# -*- coding: utf-8 -*-
"""
Created on Fri Jun 28 20:59:30 2019
...
ne_t=12 # number of Lagrange elements that constitute the cross-section
nn_t=70
...
spess=0.1    #thickness of the walls
Rb=0.6  #external rayon of boosters component
tb=0.2  #thickness boosters
...
Ctrav.append([19,18,17,9,1,2,3,11,10])
Ctrav.append([21,20,19,11,3,4,5,13,12])
Ctrav.append([23,22,21,13,5,6,7,15,14])
Ctrav.append([17,24,23,15,7,8,1,9,16])

Ctrav.append([42,41,40,32,5,25,26,34,33])
Ctrav.append([44,43,42,34,26,27,28,36,35])
Ctrav.append([46,45,44,36,28,29,30,38,37])
Ctrav.append([40,47,46,38,30,31,5,32,39])

Ctrav.append([65,64,63,55,48,49,50,57,56])
Ctrav.append([67,66,65,57,50,51,1,59,58])
Ctrav.append([69,68,67,59,1,52,53,61,60])
Ctrav.append([63,70,69,61,53,54,48,55,62])
...
dang=Ma.pi/2
for e in range(0,4):
    Con.append([ri*Ma.cos((e+1)*dang),ri*Ma.sin((e+1)*dang),ri*Ma.cos((e+1/2)*dang),ri*Ma.sin((e+1/2)*dang),ri*Ma.cos((e)*dang),ri*Ma.sin((e)*dang),rm*Ma.cos((e)*dang),rm*Ma.sin((e)*dang),re*Ma.cos((e)*dang),re*Ma.sin((e)*dang),re*Ma.cos((e+1/2)*dang),re*Ma.sin((e+1/2)*dang),re*Ma.cos((e+1)*dang),re*Ma.sin((e+1)*dang),rm*Ma.cos((e+1)*dang),rm*Ma.sin((e+1)*dang),rm*Ma.cos((e+1/2)*dang),rm*Ma.sin((e+1/2)*dang)])
...
for e in range(0,4):
    Con.append([ri*Ma.cos((e+1)*dang)+dec,ri*Ma.sin((e+1)*dang),ri*Ma.cos((e+1/2)*dang)+dec,ri*Ma.sin((e+1/2)*dang),ri*Ma.cos((e)*dang)+dec,ri*Ma.sin((e)*dang),rm*Ma.cos((e)*dang)+dec,rm*Ma.sin((e)*dang),re*Ma.cos((e)*dang)+dec,re*Ma.sin((e)*dang),re*Ma.cos((e+1/2)*dang)+dec,re*Ma.sin((e+1/2)*dang),re*Ma.cos((e+1)*dang)+dec,re*Ma.sin((e+1)*dang),rm*Ma.cos((e+1)*dang)+dec,rm*Ma.sin((e+1)*dang),rm*Ma.cos((e+1/2)*dang)+dec,rm*Ma.sin((e+1/2)*dang)])
...
def Func(el,w,rq,phiq):
    ...
    alphaq=-(phiq-(el%4+1/2)*dang)/(lqphi/2) 
    if el<4:
        betaq=(rq-(R-spess/2))/(spess/2)
    else:
        betaq=(rq-(Rb-tb/2))/(tb/2)
...
def plotundeformed():
    ...
    yk=np.array(list(np.arange(-(R+Rb),(R+Rb),0.05)))
